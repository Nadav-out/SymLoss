...
scriptsdir=/global/homes/i/inbarsav/SymLoss/Inbar/plots
...
bash -c "
    ...
    python -u train_transformer_top_multinode.py --data_dir /pscratch/sd/t/tmadula/data/ATLASTOP/ --output_dir $outdir --save_tag $SLURM_ARRAY_TASK_ID --boost_type 3D --apply_penalty
    "
