...
if broken_symm == "True" or broken_symm == True:
    ...
    symm_net.prepare_dataset(seed = seed_data, N = config["N"], batch_size = config["batch_size"], broken_symm = config["broken_symm"], spurions = config["spurions"], input_spurions = config["input_spurions"])
